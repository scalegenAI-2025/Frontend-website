    ...
    <main className={classes.page}>
      <article className={classes.container}>
        ...
        <section className={classes.section}>
          ...
          <p className={classes.content}>
            1. Right to access Your Personal Information: You have the right to
          ...
          <p className={classes.content}>
            ...
            believe your information is inaccurate or incomplete;
          </p>
          <p className={classes.content}>
          ...
          <p className={classes.content}>
            5.Right to object to Processing: You have the right to object to our
          ...
          <p className={classes.content}>
            7. Right to make a complaint to a government supervisory authority:
            If you believe we have not processed your Personal Information in
            accordance with applicable provisions of the GDPR, we encourage you
            to contact us at email address provided in the &#39;Grievances&#39;
            ...
            courts. A list of Supervisory Authorities is available
        ...
        <section className={classes.section}>
          ...
          <p className={classes.content}>
            ...
            following rights under the Personal Data Protection Bill (PDPB) when
            it becomes a legislation. All requests can be made by using the
            option provided to you within the Platform upon your login. You may
            also write to us as stated in the &quot;Grievances&quot; section
            above, and we will address you concerns to the extent required by
            law.
          </p>
          <p className={classes.content}>
          ...
          <p className={classes.content}>
            2. Right to Correction: You have the right to ask us to rectify your
            Personal Information that is with us that you think is inaccurate.
            You also have the right to ask us to update your Personal
            Information that you think is incomplete or out-of-date.
          </p>
          ...
          <p className={classes.content}>
            4. Right to be Forgotten: You have the right to restrict or prevent
            the continuing disclosure of your Personal Information under certain
            circumstances.
          </p>
          <p className={classes.content}>
        ...
        <section className={classes.section}>
          <h2 className={classes.sectionTitle}>A.CCPA NOTICE AT COLLECTION:</h2>
          <p className={classes.content}>
          ...
          <p className={classes.content}>
            ...
            number, username, unique personal identifier, and Internet Protocol
            (IP) address. We use Identifiers as set forth in the &quot;How We
            Use and Share the Information Collected&quot; section of this
            Policy, like your name, contact information, and device and online
            identifiers.
          </p>
          <p className={classes.content}>
            2. Characteristics of Personal Information described in the
            California Customer Records statute: We may collect your name, email
            address, username, unique personal identifier, and gender. We use
            Categories of Personal Information described in the California
            Consumer Records statute as set forth in the &#39;How We Use and
            Share the Information Collected&#39; section of this Policy.
          </p>
          <p className={classes.content}>
          ...
          <p className={classes.content}>
            ...
            Geolocation Data as set forth in the &quot;How We Use and Share the
            Information Collected&quot; section of this Policy.
          </p>
          <p className={classes.content}>
            5. Audio, electronic, visual or similar information: We may collect
            your profile picture or other audio or visual information uploaded
            as content to the Platform. We use audio, electronic, visual or
            similar information as set forth in the &quot;How We Use and Share
        ...
        <div className={classes.container}>
          ...
          <div className={classes.section}>
            <p className={classes.text}>
              <strong>Business and commercial purposes for collecting:</strong>
            </p>
            <ul className={classes.list}>
          ...
          <div className={classes.section}>
            <p className={classes.text}>
              ...
              categories of Personal Information during the preceding 12 months.
            </p>
          </div>
          ...
          <div className={classes.section}>
            ...
            <ul className={classes.list}>
              ...
              <li>
                Service providers (data analytics, storage, mailing, marketing,
                support)
              </li>
          ...
          <div className={classes.section}>
            ...
            <p className={classes.text}>
              If a request is submitted in an improper manner or is deficient in
              some way, we will either (i) treat it as if properly submitted or
              (ii) provide instructions to correct it.
            </p>
          </div>
          ...
          <div className={classes.section}>
            ...
            <p className={classes.text}>
              ...
              delete it and instruct our service providers to do the same unless
          ...
          <div className={classes.section}>
            ...
            <p className={classes.text}>
              <strong>Verification:</strong> You must verify your identity using
              information such as name, email, and mobile number. If we cannot
              verify identity:
            </p>
          ...
          <div className={classes.section}>
            ...
            <p className={classes.content}>
              {" "}
              If we cannot verify the identity of the person making a request to
              delete, we may deny the request. If there is no reasonable method
              by which we can verify the identity of the requestor to the degree
              of certainty required, we will state this in our response and
              explain why we have no reasonable method by which we can verify
              the identity of the requestor.
            </p>
            <p className={classes.text}>
              Authorized agents may submit requests via the methods identified
              in this Policy. If you use an authorized agent to submit a request
              to know or a request to delete, we may require you to: (1) provide
              the authorized agent with signed permission to do so; (2) verify
              your identity directly with us; and (3) directly confirm with us
              that you provided the authorized agent permission to submit the
              request. However, we will not require these actions if you have
          ...
          <div className={classes.section}>
            ...
            <p className={classes.text}>
              If requests from a User are manifestly unfounded or excessive, in
              particular because of their repetitive character, we may either
              (1) charge a reasonable fee, or (2) refuse to act on the request
              and notify the User of the reason for refusing the request. If we
              charge a fee, the amount will be based upon the administrative
          ...
          <div className={classes.section}>
            ...
            <p className={classes.text}>
              ...
              due to your exercise of the rights provided by the CCPA. We do not
              offer financial incentives and price or service differences, and
              we do not discriminate against Users/consumers for exercising
              their rights under the CCPA.s.
            </p>
          </div>
        </div>
        <section className={classes.section}>
