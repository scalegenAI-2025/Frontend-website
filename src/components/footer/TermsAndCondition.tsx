      ...
      <div className={classes.container}>
        ...
        <div className={classes.section}>
          ...
          <p className={classes.text}>
            ...
            www.Scalinggenai.com(&quot;Website&quot;). In order to access and
            use this content, you must register with Scaling GenAI and create a
          ...
          <p className={classes.text}>
            ...
            agree to notify Scaling GenAI immediately if any other person makes
            unauthorized use of your password. Scaling GenAI reserves the right
          ...
          <p className={classes.text}>
            ...
            Terms of Use, you may not access or use the site. Scaling GenAI
            reserves the right to modify these Terms of Use at any time and in
            its sole discretion. Your use of the site following any modification
            will constitute your assent to and acceptance of the modifications.
          </p>
          <p className={classes.text}>
            Upon registration, Scaling GenAI grants you a non-exclusive,
            non-transferable, non- assignable, personal license to access and
            use the Scaling GenAI content identified in the content you
            purchased via an online/offline reader.
          </p>
          <p className={classes.text}>
            ...
            Scaling GenAI will not be required to make any changes to any
            equipment or software used by Scaling GenAI or its contractors or
            agents to ensure compatibility with any equipment or software used
            by you. You may not use the site or the content on the site for any
            commercial purpose, including but not limited to the use of any of
            the content to market or sell goods or services to any person. You
            agree not to launch any automated system,including without
            limitation, &quot;robots,&quot; &quot;spiders,&quot; or
            &quot;offline readers,&quot; to access the site.
          </p>
          <p className={classes.text}>
            ...
            reason, in its sole discretion. Scaling GenAI also reserves the
            right to discontinue the Website at any time, either temporarily or
          ...
          <p className={classes.text}>
            ...
            IMPLIED. TO THE FULLEST EXTENT PERMITTED BY LAW, Scaling GenAI
            DISCLAIMS ALL WARRANTIES, EXPRESS OR IMPLIED, INCLUDING, WITHOUT
            LIMITATION, ALL IMPLIED WARRANTIES OF MERCHANTABILITY AND FITNESS
            FOR A PARTICULAR PURPOSE. Scaling GenAI MAKES NO WARRANTIES THAT THE
            ...
            CIRCUMSTANCES, INCLUDING NEGLIGENCE, SHALL Scaling GenAI BE HELD
          ...
          <p className={classes.text}>
            ...
            attorney&#39;s fees and court costs) arising out of or resulting
            from your use of this Website or the violation by you of any of
            these Terms of Use.
          </p>
          <p className={classes.text}>
          ...
          <p className={classes.text}>
            ...
            any other term or condition, and any failure by Scaling GenAI to
