        ...
        <div className={classes.content}>
          ...
          <div className={classes.textBlock}>
            ...
            <p className={classes.paragraph}>
              <b>Scaling Generative AI</b> is the brainchild of Amit Prabhu, an
            ...
            <p className={classes.paragraph}>
              ...
              , <b>Scaling Generative AI</b> helps enterprises scale generative
              AI through ecosystems.
            </p>
            <div className={classes.contact}>
              For more details,
              <br />
              Email:{" "}
              <a href="mailto:amit@amitprabhu.net">amit@amitprabhu.net</a>
              <br />
              <br />
