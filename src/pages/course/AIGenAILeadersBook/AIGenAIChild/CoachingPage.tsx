    ...
    <div style={styles.container}>
      <div style={styles.content}>
        ...
        <ul style={styles.bulletList}>
          ...
          <li style={styles.bulletItem}>
            7 important <span style={styles.purpleText}>scaling actions</span>{" "}
            to be taken using the Fast Execution and{" "}
            <span style={styles.purpleText}>Rocket Readiness Framework</span>
          </li>
        </ul>

        {/* This is the flex row for coaching + image */}
        <div style={styles.lowerSection}>
          <div style={styles.leftSection}>
            <p style={styles.sectionIntro}>
              In the <span style={styles.coachingText}>coaching</span>, there
              will be:
            </p>
            ...
            <ul style={styles.bulletList}>
              ...
              <li style={styles.bulletItem}>
                Continuous <span style={styles.purpleText}>feedback</span> on
